...
const RemoveItemContorller_1 = require("./controllers/order/RemoveItemContorller");
const SendOrderService_1 = require("./controllers/order/SendOrderService");
...
router.delete("/order/remove", isAuthenticated_1.isAuthenticated, new RemoveItemContorller_1.RemoveItemContorller().handle);
router.put("/order/send", isAuthenticated_1.isAuthenticated, new SendOrderService_1.SendOrderController().handle);
